...
exports.VectorSearchModule = VectorSearchModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [vector_search_service_1.VectorSearchService, qdrant_service_1.QdrantService],
        exports: [vector_search_service_1.VectorSearchService, qdrant_service_1.QdrantService],
    })
], VectorSearchModule);
