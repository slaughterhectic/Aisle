...
function LoginPage() {
    ...
    const login = (0, use_auth_store_1.useAuthStore)((state) => state.login);
    ...
    return (<card_1.Card>
      <card_1.CardHeader className="space-y-1">
        <card_1.CardTitle className="text-2xl font-bold">Sign in</card_1.CardTitle>
      ...
      <card_1.CardFooter className="justify-center">
        <p className="text-sm text-gray-500">
          ...
          <link_1.default href="/register" className="text-primary hover:underline">
            Sign up
          </link_1.default>
        </p>
      </card_1.CardFooter>
